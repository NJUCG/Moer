...
\label{_bvh_8h_source}\index{Bvh.h@{Bvh.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{1 }
\DoxyCodeLine{12 \textcolor{preprocessor}{\#pragma once}}
\DoxyCodeLine{13 }
\DoxyCodeLine{14 \textcolor{preprocessor}{\#include "{}CoreLayer/Geometry/BoundingBox.h"{}}}
...
\DoxyCodeLine{64 }
\DoxyCodeLine{69     std::shared\_ptr<BvhTreeNode> RecursiveBuild(std::vector<EntityInfo>\& entityInfo, }
\DoxyCodeLine{70                                                 \textcolor{keywordtype}{int} start, \textcolor{keywordtype}{int} end, \textcolor{keywordtype}{int}\& nodeNumber, }
\DoxyCodeLine{71                                                 std::vector<std::shared\_ptr<Entity>>\& orderedEntites);}
\DoxyCodeLine{72 }
\DoxyCodeLine{74     \textcolor{keywordtype}{void} Flatten(std::shared\_ptr<BvhTreeNode> node, \textcolor{keywordtype}{int}\& dfsOrder);}
\DoxyCodeLine{75 }
\DoxyCodeLine{77     std::optional<Intersection> Intersect(\textcolor{keyword}{const} \mbox{\hyperlink{struct_ray}{Ray}}\& r);}
\DoxyCodeLine{78 \};}
