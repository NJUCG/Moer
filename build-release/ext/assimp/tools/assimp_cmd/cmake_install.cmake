# Install script for directory: /mnt/renderer/Zero/ext/assimp/tools/assimp_cmd
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xassimp-binx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/mnt/renderer/Zero/build-release/ext/assimp/bin/assimp")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/assimp"
         OLD_RPATH "/mnt/renderer/Zero/build-release/ext/assimp:/mnt/renderer/Zero/build-release/ext/assimp/lib:/mnt/renderer/Zero/target/lib:"
         NEW_RPATH "")
