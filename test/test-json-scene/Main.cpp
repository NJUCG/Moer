...
TEST_CASE("load-cornell-box")
{
   ...
   // scene->addEntity(std::make_shared<Quad>());
    ...
    PathIntegrator integrator(pinhole, std::make_unique<Film>(Point2i(1000, 563), 3), std::make_unique<SequenceTileGenerator>(Point2i(1000, 563)), std::make_shared<IndependentSampler>(), 25, 12);
